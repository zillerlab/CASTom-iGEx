...
parser$add_argument("--pval_feat", deafult = 1, type = "double",  help = "")
...
# 
# clustFile <- sprintf('/home/luciat/eQTL_PROJECT/OUTPUT_GTEx/predict_PGC/%s/200kb/PGC_GWAS_bin1e-2/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/tscore_zscaled_clusterCases_PGmethod_HKmetric.RData', tissue_name)
# 
# tscore_featRelFile <- sprintf('/home/luciat/eQTL_PROJECT/OUTPUT_GTEx/predict_PGC/%s/200kb/PGC_GWAS_bin1e-2/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/tscoreOriginal_tscoreClusterCases_featAssociation.RData', tissue_name)
# 
# pathR_featRelFile<- sprintf('/home/luciat/eQTL_PROJECT/OUTPUT_GTEx/predict_PGC/%s/200kb/PGC_GWAS_bin1e-2/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/path_ReactomeOriginal_tscoreClusterCases_featAssociation.RData', tissue_name)
# 
# pathGO_featRelFile<- sprintf('/home/luciat/eQTL_PROJECT/OUTPUT_GTEx/predict_PGC/%s/200kb/PGC_GWAS_bin1e-2/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/path_GOOriginal_tscoreClusterCases_featAssociation.RData', tissue_name)
# 
# outFold <- sprintf('/home/luciat/eQTL_PROJECT/OUTPUT_GTEx/predict_PGC/%s/200kb/PGC_GWAS_bin1e-2/Meta_Analysis_SCZ/devgeno0.01_testdevgeno0/', tissue_name)
# 
