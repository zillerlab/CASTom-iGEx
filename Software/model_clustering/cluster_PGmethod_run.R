...
ggsave(filename = sprintf('%s%s_%s_cluster%s_PGmethod_%smetric_PCs.png', outFold, type_data, type_input, type_cluster, type_sim), width = 13, height = 4, plot = p, device = 'png')
ggsave(filename = sprintf('%s%s_%s_cluster%s_PGmethod_%smetric_PCs.pdf', outFold, type_data, type_input, type_cluster, type_sim), width = 13, height = 4, plot = p, device = 'pdf')
...
ggsave(filename = sprintf('%s%s_%s_cluster%s_PGmethod_%smetric_Age_Sex.png', outFold, type_data, type_input, type_cluster, type_sim), width = 6.5, height = 3, plot = tot_pl, device = 'png')
ggsave(filename = sprintf('%s%s_%s_cluster%s_PGmethod_%smetric_Age_Sex.pdf', outFold, type_data, type_input, type_cluster, type_sim), width = 6.5, height = 3, plot = tot_pl, device = 'pdf')
