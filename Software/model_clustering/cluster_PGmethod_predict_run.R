...
# outFold <- '/psycl/g/mpsziller/lucia/CAD_UKBB/eQTL_PROJECT/OUTPUT_GTEx/predict_CAD/Liver/200kb/CAD_GWAS_bin5e-2/CG/devgeno0.01_testdevgeno0/CAD_HARD_clustering/'
# tissues_name <- 'Liver'
...
res_pred <- project_clust_PGmethod_HKsim(kNN = clust_res$best_k, score = data_tot, data_mod = clust_res$input_data, 
                                         sample_info = sampleAnn_new, euclDist = ed_dist, cl_mod = clust_res$cl_best)
