...
# cor_file <-  paste0('/psycl/g/mpsziller/lucia/UKBB/eQTL_PROJECT/OUTPUT_GTEx/predict_UKBB/',tissue_name,'/200kb/noGWAS/devgeno0.01_testdevgeno0/correlation_estimate_tot_path.RData')
# type_data <- 'tot_path'
