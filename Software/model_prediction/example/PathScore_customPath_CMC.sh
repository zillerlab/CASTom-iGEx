#!/bin/bash
#SBATCH -o /home/luciat/eQTL_PROJECT/err_out_fold/custom_pathDiff_%x_CMC.out
#SBATCH -e /home/luciat/eQTL_PROJECT/err_out_fold/custom_pathDiff_%x_CMC.err
#SBATCH -N 1
#SBATCH --mem=20G
#SBATCH -t 48:00:00
...
file_path_name=$1
path_name=$2
fold=OUTPUT_CMC/predict_PGC/200kb/${c}/devgeno0.01_testdevgeno0/
