...
# type_data <- 'tscore'
# enrich_file <- 'Meta_Analysis_SCZ/Brain_Frontal_Cortex_BA9/enrichment_SCZ-UKBB_res/perc0.3_dist250000b_correlation_enrich_SCZ_relatedPheno.RData'
# outFold <- 'Meta_Analysis_SCZ/Brain_Frontal_Cortex_BA9/enrichment_SCZ-UKBB_res/dist250000b_'
# pval_FDR_rel <- 0.05
# pval_FDR_corr <- 0.05
##########################################################################################################################
