# functions called in ElNet_withPrior (part1 to part4 + plots) scripts
### NOTE:
...
#### used in ElNet_withPrior_part1_run.R ####
...
#### used in ElNet_withPrior_part1_run.R and ElNet_withPrior_part2_run.R and ElNet_withPrior_part4_run.R####
...
deviance_funct <- function(genDat, expDat, covDat, modelMatrix, FoldK){
  ...
  return(cbind(dev.ratio, dev_geno, dev_cov, dev_geno_cov, cor_est, cor_pval))
  
}

#### used in ElNet_withPrior_part2_run.R ####
