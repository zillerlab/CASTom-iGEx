...
ggsave(filename =  sprintf('%s%s_UMAPp_SVM_FDRpval%s_umap.png', outFold, type_data, as.character(pval_thr)), width = 4, height = 4, plot = pl1, device = 'png')
ggsave(filename =  sprintf('%s%s_UMAPp_SVM_FDRpval%s_umap.pdf', outFold, type_data, as.character(pval_thr)), width = 4, height = 4, plot = pl1, device = 'pdf')
...
ggsave(filename = sprintf('%s%s_UMAPp_SVM_FDRpval%s_umap_cov.png', outFold, type_data, as.character(pval_thr)), width = 12, height = 8, plot = tot_pl, device = 'png')
ggsave(filename = sprintf('%s%s_UMAPp_SVM_FDRpval%s_umap_cov.pdf', outFold, type_data, as.character(pval_thr)), width = 12, height = 8, plot = tot_pl, device = 'pdf')
...
save(output, file = sprintf('%s%s_UMAPp_SVM_FDRpval%s.RData', outFold, type_data, as.character(pval_thr)))
